...
<script>
    $(function () {
        ...
        $(".address-table input,.address-table textarea").blur(function () {
    ...
    <form action="${pageContext.request.contextPath}/createOrder" method="post">
        ...
        <table class="address-table">
            ...
            <tr>
                ...
                <td class="right-column"><textarea placeholder="建议您如实填写详细收货地址，例如接到名称，门牌号码，楼层和房间号等信息"
                                                   name="address" autocomplete="off"></textarea></td>
            </tr>
            <tr>
                <td class="left-column">邮政编码</td>
                <td class="right-column"><input type="text" placeholder="如果您不清楚邮递区号，请不要填写" name="post" autocomplete="off"></td>
            </tr>
            <tr>
                <td class="left-column">收货人姓名<span class="red-star">*</span></td>
                <td class="right-column"><input type="text" placeholder="长度不超过25个字符" name="receiver" autocomplete="off"></td>
            </tr>
            <tr>
                <td class="left-column">手机号码 <span class="red-star">*</span></td>
                <td class="right-column"><input type="text" placeholder="请输入11位手机号码" name="mobile" autocomplete="off"></td>
            </tr>
            </tbody>
        </table>
        ...
        <table class="buy-list">
            ...
            <tr>
                <th class="shop-and-wangwang" colspan="2">
                    ...
                    <a href="${pageContext.request.contextPath}" class="market-link">店铺：${website_name}</a>
            ...
            <tr class="buy-item">
                <td class="buy-item-image"> <a href="${pageContext.request.contextPath}/product?id=${item.product.id}"><img src="${productImgDir}${item.product.image.path}"></a></td>
                <td class="buy-item-name"><a href="${pageContext.request.contextPath}/product?id=${item.product.id}">${item.product.name}</a>
        ...
        <table class="sum-bar">
            <tr>
                ...
                <td>
                    运送方式：
                    <select class="delivery-select" style="width: 99px;height: 23px;text-align: center" >
                        <option style="width: 80px">快递  免邮费</option>
                    </select>
        ...
        <div class="confirm-frame pull-right" style="margin-bottom: 10px">
