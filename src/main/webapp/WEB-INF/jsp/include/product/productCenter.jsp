...
<section class="property">
    ...
    <div class="detail">
        ...
        <div class="product-num">
            ...
            <span class="arrow">
                    <a class="increase-number" id="increase-number" style="cursor: pointer">
                    <span class="updown arrow-png">
                       <img src="img/increase.png">
                    </span>
                    </a>
                    <span class="updown-middle"> </span>
                    <a class="decrease-number" id="decrease-number"  style="cursor: pointer">
                    <span class="updown arrow-png">
        ...
        <div class="buy">
            <input type="hidden" value="${user.username}" id="userhidden">
            <a href="${pageContext.request.contextPath}/buyOne?pid=${product.id}" id="buy-link" class="display:none;"></a>
            <a href="${pageContext.request.contextPath}/addCart?pid=${product.id}" id="cart-link" class="display:none;"></a>
