...
<main class="product-content">
    <div class="product-bar">
        <div class="product-select selected" style="cursor: pointer" id="button-1">
            <a style="cursor: pointer">商品详情</a>
        </div>
        <div class="product-select" style="cursor: pointer" id="button-2">
